...
RSpec.describe 'calculate_reading_time' do
    ...
    context 'given a text of under two hundred words' do
      ...
      context 'given a text of under three hundred words' do
        it 'returns two' do
  ...
  context 'given a text of under four hundred words' do
        it 'returns two' do
  ...
  context 'given a text of under five thousand words' do
